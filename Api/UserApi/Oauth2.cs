...
namespace Api.UserApi
{
    ...
    public class Oauth2
    {
        ...
        public string CodeGetOpenid(string Appid, string Appsecret, string Code)
        {
            ...
            string ReText = CommonMethod.WebRequestPostOrGet(url, "","post");//post/get方法获取信息 
        ...
        public string GetUserInfo(string Appid, string Appsecret, string Code)
        {
            ...
            {
                return CommonMethod.WebRequestPostOrGet("https://api.weixin.qq.com/sns/userinfo?access_token=" + DicText["access_token"] + "&openid=" + DicText["openid"] + "&lang=zh_CN", "","post");
            }
        }
    }
}
